...
<link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:200,200i,300,300i,400,400i,600,600i,700,700i,900,900i" rel="stylesheet">
        ...
        <link href="home-assets/vendor/fontawesome-free/css/fontawesome.css" rel="stylesheet" type="text/css" >
                <link href="home-assets/vendor/fontawesome-free/css/all.css" rel="stylesheet" type="text/css" >
                ...
                <div class="row h-100">
                    <div class="col-12 my-auto">
                        <div class="masthead-content text-white py-5 py-md-0">
                            <h1 class="mb-3"><?php echo e(config('swagger-lume.api.title')); ?></h1>
        ...
        <div class="social-icons">
            <ul class="list-unstyled text-center mb-0">
                <li class="list-unstyled-item">
                    ...
                    <a href="<?php echo e(route('swagger-lume.docs')); ?>" id="docs">
                        <i class="fab fa-gratipay"></i>
                    </a>
                </li>
                <li class="list-unstyled-item">
                    <label for="api">API</label>
                    <a href="<?php echo e(route('swagger-lume.api')); ?>" id="api">
